<?php
namespace Opencart\Catalog\Model\Extension\Open929\Payment;
class NmiCollectjs extends \Opencart\System\Engine\Model {
	public function getMethod(array $address): array {
		...
		if (!$this->config->get('payment_nmi_collectjs_geo_zone_id')) {
			$status = true;
